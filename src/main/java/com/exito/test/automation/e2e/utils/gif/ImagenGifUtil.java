package com.exito.test.automation.e2e.utils.gif;
...
/**
 * https://github.com/Deep-Symmetry/wayang/blob/main/src/main/java/org/deepsymmetry/GifSequenceWriter.java
 *
 ...
 */
public class ImagenGifUtil {
    protected ImageWriter gifWriter;
    protected ImageWriteParam imageWriteParam;
    protected IIOMetadata imageMetaData;

    public ImagenGifUtil(
    ...
    public static void main(String[] args) throws Exception {
        if (args.length > 1) {
            ...
            ImagenGifUtil writer =
                new ImagenGifUtil(output, firstImage.getType(), 1, false);
